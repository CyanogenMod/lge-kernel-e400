...
static struct platform_device *m3mpcs_devices[] __initdata = {
	&msm_device_dmov,
	&msm_device_smd,
...
static void __init msm7x27a_init_ebi2(void)
{
	...
	if (machine_is_msm7x27a_rumi3() || machine_is_msm7x27a_surf() || machine_is_msm7x27a_m3mpcs())
		ebi2_cfg |= (1 << 4); /* CS2 */
	...
	ebi2_cfg = readl(ebi2_cfg_ptr);
	if (machine_is_msm7x27a_surf() || machine_is_msm7x27a_m3mpcs())
		ebi2_cfg |= (1 << 31);
...
static void __init msm7x2x_init(void)
{
	...
	msm7x27a_init_ebi2();
		...
		platform_add_devices(m3mpcs_devices,
				ARRAY_SIZE(m3mpcs_devices));
#ifdef CONFIG_USB_EHCI_MSM_72K
		msm7x2x_init_host();
#endif
