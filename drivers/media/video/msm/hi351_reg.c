...
struct hi351_i2c_reg_conf hi351_reg_settings[] = {
     ...
     {0x03, 0x00, BYTE_LEN}, // 2011 12 02 Viper clear setting applied. 
	{0x01, 0xf1, BYTE_LEN}, //hi351_tuning_new_blc_lsc_awb2_gain.txt
	...
	///////////////////////////////////////////        
	{0x03, 0x00, BYTE_LEN},
	{0x50, 0x01, BYTE_LEN}, // HBLANK 2180 + 320 = 2500
	{0x51, 0x20, BYTE_LEN},
	...
	//BLC
	{0x80, 0x02, BURST_TYPE},	//- Burst Start
	...
	{0x8b, 0x00, BURST_TYPE},	//- Burst Stop
	{0x8e, 0x80, BYTE_LEN},	
	{0x8f, 0x0f, BYTE_LEN},
	{0x90, 0x0c, BYTE_LEN}, //BLC_TIME_TH_ON
	{0x91, 0x0c, BYTE_LEN}, //BLC_TIME_TH_OFF 
	{0x92, 0x98, BYTE_LEN}, //BLC_AG_TH_ON
	{0x93, 0x90, BYTE_LEN}, //BLC_AG_TH_OFF
	...
	{0x24, 0x77, BYTE_LEN},
	{0x2b, 0x00, BURST_TYPE},	//- Burst Start
	...
	{0x37, 0x70, BURST_TYPE},
	{0x38, 0x14, BURST_TYPE},
	{0x39, 0x02, BURST_TYPE},
	{0x3a, 0x00, BYTE_LEN},	//- Burst Stop

	{0x3d, 0x70, BURST_TYPE},	//- Burst Start
	...
	{0x44, 0x00, BYTE_LEN},	//- Burst Stop
	{0x46, 0x00, BURST_TYPE},	//- Burst Start
	...
	{0x5d, 0x00, BYTE_LEN},	//- Burst Stop
	{0x60, 0x04, BURST_TYPE},	//- Burst Start
	...
	{0x7f, 0x00, BYTE_LEN},	//- Burst Stop
	{0xa0, 0x00, BURST_TYPE},	//- Burst Start
	...
	{0xd4, 0x0a, BURST_TYPE},//DCDC_TIME_TH_ON 
	{0xd5, 0x0a, BURST_TYPE},//DCDC_TIME_TH_OFF
	{0xd6, 0x98, BURST_TYPE},//DCDC_AG_TH_ON   
	{0xd7, 0x90, BYTE_LEN},//DCDC_AG_TH_OFF  	//- Burst Stop
	{0xE0, 0xf0, BURST_TYPE},//ncp adaptive	//- Burst Start
	{0xE1, 0xf0, BURST_TYPE},//ncp adaptive
	{0xE2, 0xf0, BURST_TYPE},//ncp adaptive
	{0xE3, 0xf0, BURST_TYPE},//ncp adaptive
	{0xE4, 0xe1, BURST_TYPE},//ncp adaptive
	...
	{0xF0, 0x0c, BYTE_LEN},	//- Burst Stop
	{0xF3, 0x05, BURST_TYPE},	//- Burst Start
	...
	{0xFF, 0x00, BURST_TYPE},	//- Burst Stop
	///////////////////////////////////////////
	//3Page
	///////////////////////////////////////////
	{0x03, 0x03, BYTE_LEN},	
	{0x10, 0x00, BURST_TYPE},	//- Burst Start
	...
	{0xaf, 0x64, BYTE_LEN},	//- Burst Stop
	
	{0xc0, 0x00, BURST_TYPE},	//- Burst Start
	...
	{0xf2, 0x00, BURST_TYPE},	//- Burst Stop
	...
	//Desat - Chroma 
	//Desat - Chroma              
	{0x70, 0x0c, BURST_TYPE},	//- Burst Start
	{0x71, 0x01, BURST_TYPE},
	{0x72, 0x66, BURST_TYPE},
	{0x73, 0xcc, BURST_TYPE},
	{0x74, 0x88, BURST_TYPE},
	{0x75, 0x05, BURST_TYPE},
	{0x76, 0x33, BURST_TYPE},
	{0x77, 0x49, BURST_TYPE},
	{0x78, 0x99, BURST_TYPE},
	{0x79, 0x4c, BURST_TYPE},
	{0x7a, 0xcc, BURST_TYPE},
	{0x7b, 0x49, BURST_TYPE},
	{0x7c, 0x99, BURST_TYPE},
	{0x7d, 0x14, BURST_TYPE},
	{0x7e, 0x28, BURST_TYPE},
	{0x7f, 0x50, BURST_TYPE},	//- Burst Stop
	...
	//DLPF
	{0x03, 0x11, BYTE_LEN},
	{0xf0, 0x00, BURST_TYPE},	//- Burst Start
	...
	{0xf7, 0x00, BURST_TYPE},	//- Burst Stop
	///////////////////////////////////////////
	// 12 page DPC / GBGR /LensDebulr
	///////////////////////////////////////////             
	{0x03, 0x12, BYTE_LEN},                      
	{0x10, 0x57, BURST_TYPE},	//- Burst Start
	{0x11, 0x29, BURST_TYPE},
	{0x12, 0x30, BURST_TYPE},
	...
	{0x3F, 0x00, BURST_TYPE},	//- Burst Stop
	...
	{0x60, 0x3f, BYTE_LEN}, //mcmc

	//automatic saturation
	{0x8a, 0x6d, BURST_TYPE},	//- Burst Start
	{0x8b, 0x73, BURST_TYPE},
	{0x8c, 0x79, BURST_TYPE},
	...
	{0x9a, 0x7f, BURST_TYPE},	//- Burst Stop
	...
	{0x20, 0x00, BURST_TYPE}, //EXP Normal 30.00 fps 	//- Burst Start
	...
	{0x29, 0x05, BURST_TYPE}, 
	{0x2a, 0x94, BYTE_LEN}, 	//- Burst Stop
	{0x30, 0x05, BURST_TYPE}, //EXP100 	//- Burst Start
	...
	{0x38, 0x94, BURST_TYPE}, 	//- Burst Stop
	...
	{0x51, 0xC0, BYTE_LEN}, //pga_max_total A0 -> C0 STEVE
	{0x52, 0x28, BYTE_LEN}, //pga_min_total

	{0x71, 0x80, BYTE_LEN}, //DG MAX   80 -> A0 STEVE
	...
	{0x11, 0x30, BYTE_LEN}, // ae speed B[7:6] 0 (SLOW) ~ 3 (FAST), 0x70 - 0x30   
        {0x12, 0x10, BYTE_LEN},         
	{0x19, 0x30, BURST_TYPE}, // band0 gain 40fps 0x2d  //-Burst Start
	...
	{0x29, 0xc0, BURST_TYPE},	//- Burst Stop
	...
	{0x03, 0xc4, BYTE_LEN},
	{0x12, 0xb0, BYTE_LEN},//Auto bias set bit[5]


	{0xed, 0x00, BURST_TYPE},	//- Burst Start
	{0xee, 0xff, BURST_TYPE},
	{0xef, 0x00, BURST_TYPE},
	{0xf0, 0x00, BURST_TYPE},
	{0xf1, 0x00, BURST_TYPE},
	{0xf2, 0x00, BURST_TYPE},
	{0xf3, 0x00, BURST_TYPE},
	{0xf4, 0x00, BURST_TYPE},
	{0xf5, 0x00, BURST_TYPE},
	{0xf6, 0x00, BURST_TYPE},
	{0xf7, 0x00, BURST_TYPE},
	{0xf8, 0x00, BURST_TYPE},
	{0xf9, 0x00, BURST_TYPE},
	{0xfa, 0x00, BURST_TYPE},
	{0xfb, 0x00, BURST_TYPE},	//- Burst Stop
	...
	{0x03, 0xc3, BYTE_LEN},
	{0x10, 0x00, BYTE_LEN},
	{0x38, 0xFE, BURST_TYPE},	//- Burst Start
	...
	{0xA5, 0x11, BURST_TYPE},	//- Burst Stop
	...
	{0x10, 0x10, BURST_TYPE},	//- Burst Start
	{0x11, 0x1c, BURST_TYPE},
	{0x12, 0x30, BURST_TYPE},
	{0x13, 0x40, BURST_TYPE},
	{0x14, 0x80, BURST_TYPE},
	{0x15, 0xff, BURST_TYPE},
	{0x16, 0x00, BURST_TYPE},
	{0x17, 0x00, BURST_TYPE},	//- Burst Stop
...
{0x03, 0xc5, BYTE_LEN}, 
{0x10, 0x30, BURST_TYPE},	//- Burst Start
{0x11, 0xa0, BURST_TYPE},
{0x12, 0x17, BURST_TYPE},
...
{0x24, 0x00, BURST_TYPE},
{0x25, 0xa0, BURST_TYPE},
{0x26, 0x01, BURST_TYPE},
{0x27, 0x09, BURST_TYPE},
{0x28, 0x00, BURST_TYPE},
{0x29, 0x64, BURST_TYPE},
{0x2a, 0x00, BURST_TYPE},
{0x2b, 0xd2, BURST_TYPE},
{0x2c, 0x00, BURST_TYPE},
{0x2d, 0x82, BURST_TYPE},
{0x2e, 0x00, BURST_TYPE},
{0x2f, 0x00, BURST_TYPE},
...
{0x3b, 0x0d, BURST_TYPE},
{0x3c, 0xbb, BURST_TYPE},
...
{0x4a, 0x00, BURST_TYPE},
{0x4b, 0x05, BURST_TYPE},
{0x4c, 0x57, BURST_TYPE},
{0x4d, 0x30, BURST_TYPE},
{0x4e, 0x05, BURST_TYPE}, //bRgOfs_a00_n00
{0x4f, 0x00, BURST_TYPE},//wb slop offset b
...
{0x6b, 0x22, BURST_TYPE}, //aInWhtRgnBg_a00_n00
{0x6c, 0x29, BURST_TYPE}, //aInWhtRgnBg_a01_n00
{0x6d, 0x2d, BURST_TYPE}, //aInWhtRgnBg_a02_n00
{0x6e, 0x34, BURST_TYPE}, //aInWhtRgnBg_a03_n00
{0x6f, 0x3f, BURST_TYPE}, //aInWhtRgnBg_a04_n00
{0x70, 0x4a, BURST_TYPE}, //aInWhtRgnBg_a05_n00
{0x71, 0x54, BURST_TYPE}, //aInWhtRgnBg_a06_n00
{0x72, 0x5d, BURST_TYPE}, //aInWhtRgnBg_a07_n00
{0x73, 0x67, BURST_TYPE}, //aInWhtRgnBg_a08_n00
{0x74, 0x72, BURST_TYPE}, //aInWhtRgnBg_a09_n00
{0x75, 0x7e, BURST_TYPE}, //aInWhtRgnBg_a10_n00
{0x76, 0x86, BURST_TYPE}, //aInWhtRgnRgLeftLmt_a00_n00
{0x77, 0x73, BURST_TYPE}, //aInWhtRgnRgLeftLmt_a01_n00
{0x78, 0x68, BURST_TYPE}, //aInWhtRgnRgLeftLmt_a02_n00
{0x79, 0x56, BURST_TYPE}, //aInWhtRgnRgLeftLmt_a03_n00
{0x7a, 0x4a, BURST_TYPE}, //aInWhtRgnRgLeftLmt_a04_n00
{0x7b, 0x44, BURST_TYPE}, //aInWhtRgnRgLeftLmt_a05_n00
{0x7c, 0x40, BURST_TYPE}, //aInWhtRgnRgLeftLmt_a06_n00
{0x7d, 0x3d, BURST_TYPE}, //aInWhtRgnRgLeftLmt_a07_n00
{0x7e, 0x3a, BURST_TYPE}, //aInWhtRgnRgLeftLmt_a08_n00
{0x7f, 0x38, BURST_TYPE}, //aInWhtRgnRgLeftLmt_a09_n00
{0x80, 0x35, BURST_TYPE}, //aInWhtRgnRgLeftLmt_a10_n00
{0x81, 0xa0, BURST_TYPE}, //aInWhtRgnRgRightLmt_a00_n00
{0x82, 0x95, BURST_TYPE}, //aInWhtRgnRgRightLmt_a01_n00
{0x83, 0x8c, BURST_TYPE}, //aInWhtRgnRgRightLmt_a02_n00
{0x84, 0x80, BURST_TYPE}, //aInWhtRgnRgRightLmt_a03_n00
{0x85, 0x71, BURST_TYPE}, //aInWhtRgnRgRightLmt_a04_n00
{0x86, 0x63, BURST_TYPE}, //aInWhtRgnRgRightLmt_a05_n00
{0x87, 0x5b, BURST_TYPE}, //aInWhtRgnRgRightLmt_a06_n00
{0x88, 0x53, BURST_TYPE}, //aInWhtRgnRgRightLmt_a07_n00
{0x89, 0x4f, BURST_TYPE}, //aInWhtRgnRgRightLmt_a08_n00
{0x8a, 0x4c, BURST_TYPE}, //aInWhtRgnRgRightLmt_a09_n00
{0x8b, 0x4a, BURST_TYPE}, //aInWhtRgnRgRightLmt_a10_n00
{0x8c, 0x22, BURST_TYPE}, //aInWhtLineBg_a00_n00
{0x8d, 0x2b, BURST_TYPE}, //aInWhtLineBg_a01_n00
{0x8e, 0x2e, BURST_TYPE}, //aInWhtLineBg_a02_n00
{0x8f, 0x33, BURST_TYPE}, //aInWhtLineBg_a03_n00
{0x90, 0x38, BURST_TYPE}, //aInWhtLineBg_a04_n00
{0x91, 0x40, BURST_TYPE}, //aInWhtLineBg_a05_n00
{0x92, 0x49, BURST_TYPE}, //aInWhtLineBg_a06_n00
{0x93, 0x52, BURST_TYPE}, //aInWhtLineBg_a07_n00
{0x94, 0x5e, BURST_TYPE}, //aInWhtLineBg_a08_n00
{0x95, 0x6e, BURST_TYPE}, //aInWhtLineBg_a09_n00
{0x96, 0x7d, BURST_TYPE}, //aInWhtLineBg_a10_n00
{0x97, 0x91, BURST_TYPE}, //aInWhtLineRg_a00_n00
...
{0x9b, 0x64, BURST_TYPE}, //aInWhtLineRg_a04_n00
{0x9c, 0x57, BURST_TYPE}, //aInWhtLineRg_a05_n00
{0x9d, 0x4f, BURST_TYPE}, //aInWhtLineRg_a06_n00
{0x9e, 0x4a, BURST_TYPE}, //aInWhtLineRg_a07_n00
{0x9f, 0x44, BURST_TYPE}, //aInWhtLineRg_a08_n00
{0xa0, 0x41, BURST_TYPE}, //aInWhtLineRg_a09_n00
{0xa1, 0x3e, BURST_TYPE}, //aInWhtLineRg_a10_n00
...
{0xf8, 0x64, BURST_TYPE},
{0xf9, 0x05, BURST_TYPE},
{0xfa, 0x32, BURST_TYPE},
{0xfb, 0x28, BURST_TYPE},
{0xfc, 0x64, BURST_TYPE},
{0xfd, 0x14, BURST_TYPE},//indoor angle offset 26->14
{0xfe, 0x1e, BURST_TYPE},
{0xff, 0x1e, BURST_TYPE},//pt core	//- Burst Stop

{0x03, 0xc6, BYTE_LEN}, 
{0x10, 0x1e, BURST_TYPE},	//- Burst Start
...
{0x19, 0xf0, BURST_TYPE},
{0x1a, 0x40, BURST_TYPE},
{0x1b, 0xf0, BURST_TYPE},
...
{0x49, 0x72, BURST_TYPE}, //aOutWhtLineBg_a10_n00
...
{0x50, 0x4d, BURST_TYPE}, //aOutWhtLineRg_a06_n00
{0x51, 0x46, BURST_TYPE},
{0x52, 0x44, BURST_TYPE},
{0x53, 0x42, BURST_TYPE},
{0x54, 0x41, BURST_TYPE},
{0x55, 0x50, BURST_TYPE},
{0x56, 0x5a, BURST_TYPE},
{0x57, 0x64, BURST_TYPE},
...
{0x95, 0x20, BURST_TYPE},
{0x96, 0x1e, BURST_TYPE},
{0x97, 0x1c, BURST_TYPE},
{0x98, 0x1a, BURST_TYPE},
{0x99, 0x18, BURST_TYPE},
{0x9a, 0x16, BURST_TYPE},
{0x9b, 0x14, BURST_TYPE},
{0x9c, 0x14, BURST_TYPE},
{0x9d, 0x14, BURST_TYPE},
{0x9e, 0x12, BURST_TYPE},
{0x9f, 0x12, BURST_TYPE},
{0xa0, 0x08, BURST_TYPE},
{0xa1, 0x08, BURST_TYPE},
{0xa2, 0x08, BURST_TYPE},
{0xa3, 0x07, BURST_TYPE},
{0xa4, 0x07, BURST_TYPE},
{0xa5, 0x07, BURST_TYPE},
{0xa6, 0x06, BURST_TYPE},
{0xa7, 0x06, BURST_TYPE},
{0xa8, 0x05, BURST_TYPE},
{0xa9, 0x05, BURST_TYPE},
{0xaa, 0x04, BURST_TYPE},
{0xab, 0x64, BURST_TYPE},
...
{0xbe, 0x00, BURST_TYPE},
{0xbf, 0xcd, BURST_TYPE},	//- Burst Stop

{0x03, 0xc7, BYTE_LEN}, //Page C7
{0x89, 0x10, BYTE_LEN}, //reserved
{0x8a, 0x10, BYTE_LEN}, //reserved
	///////////////////////////////////////////
	...
	{0x03, 0xc9, BYTE_LEN},
	{0x42, 0x68, BYTE_LEN}, //Rgain (16a2)
	{0x43, 0x40, BYTE_LEN}, //Ggain
	{0x44, 0x70, BYTE_LEN}, //Bgain (16a4)
	...
	{0x3f, 0x2c, BURST_TYPE},	//YLVL_00
	{0x40, 0x2c, BURST_TYPE},	//YLVL_01
	{0x41, 0x2c, BURST_TYPE},	//YLVL_02
	{0x42, 0x2c, BURST_TYPE},	//YLVL_03
	{0x43, 0x2c, BURST_TYPE},	//YLVL_04
	{0x44, 0x2c, BURST_TYPE},	//YLVL_05
	{0x45, 0x34, BURST_TYPE},  //YLVL_06   
	{0x46, 0x34, BURST_TYPE},  //YLVL_07   
	{0x47, 0x34, BURST_TYPE},  //YLVL_08   
	{0x48, 0x34, BURST_TYPE},	//YLVL_09   
	{0x49, 0x34, BURST_TYPE},	//YLVL_10   
	{0x4a, 0x34, BURST_TYPE},	//36 YLVL_11
	{0x4b, 0x90, BURST_TYPE},  //YCON_00
	{0x4c, 0x90, BURST_TYPE},  //YCON_01
	{0x4d, 0x90, BURST_TYPE},  //YCON_02
	...
	{0x58, 0x80, BURST_TYPE},
	{0x59, 0x80, BURST_TYPE},
	{0x5a, 0x80, BURST_TYPE},
	{0x5b, 0x80, BURST_TYPE},
	{0x5c, 0x80, BURST_TYPE},
	{0x5d, 0x80, BURST_TYPE},
	{0x5e, 0x80, BURST_TYPE},
	{0x5f, 0x80, BURST_TYPE},
	...
	{0x63, 0x14, BURST_TYPE},	//GMA00
	{0x64, 0x21, BURST_TYPE},
	{0x65, 0x31, BURST_TYPE},
	{0x66, 0x3d, BURST_TYPE},
	{0x67, 0x49, BURST_TYPE},
	{0x68, 0x58, BURST_TYPE},
	{0x69, 0x64, BURST_TYPE},
	{0x6a, 0x6f, BURST_TYPE},
	{0x6b, 0x79, BURST_TYPE},
	{0x6c, 0x82, BURST_TYPE},
	{0x6d, 0x8b, BURST_TYPE},
	{0x6e, 0x8f, BURST_TYPE},
	{0x6f, 0x94, BURST_TYPE},
	{0x70, 0x99, BURST_TYPE},
	{0x71, 0x9c, BURST_TYPE},
	{0x72, 0x9f, BURST_TYPE},
	{0x73, 0xa3, BURST_TYPE},
	{0x74, 0xa6, BURST_TYPE},
	{0x75, 0xa9, BURST_TYPE},
	{0x76, 0xac, BURST_TYPE},
	{0x77, 0xaf, BURST_TYPE},
	{0x78, 0xb3, BURST_TYPE},
	{0x79, 0xb7, BURST_TYPE},
	{0x7a, 0xba, BURST_TYPE},
	{0x7b, 0xc1, BURST_TYPE},
	{0x7c, 0xc6, BURST_TYPE},
	{0x7d, 0xca, BURST_TYPE},
	{0x7e, 0xcf, BURST_TYPE},
	{0x7f, 0xd3, BURST_TYPE},
	{0x80, 0xd7, BURST_TYPE},
	{0x81, 0xdb, BURST_TYPE},
	{0x82, 0xdf, BURST_TYPE},
	{0x83, 0xe3, BURST_TYPE},
	{0x84, 0xe5, BURST_TYPE},
	{0x85, 0x14, BURST_TYPE},	//GMA01
	{0x86, 0x21, BURST_TYPE},
	{0x87, 0x31, BURST_TYPE},
	{0x88, 0x3d, BURST_TYPE},
	{0x89, 0x49, BURST_TYPE},
	{0x8a, 0x58, BURST_TYPE},
	{0x8b, 0x64, BURST_TYPE},
	{0x8c, 0x6f, BURST_TYPE},
	{0x8d, 0x79, BURST_TYPE},
	{0x8e, 0x82, BURST_TYPE},
	{0x8f, 0x8b, BURST_TYPE},
	{0x90, 0x8f, BURST_TYPE},
	{0x91, 0x94, BURST_TYPE},
	{0x92, 0x99, BURST_TYPE},
	{0x93, 0x9c, BURST_TYPE},
	{0x94, 0x9f, BURST_TYPE},
	{0x95, 0xa3, BURST_TYPE},
	{0x96, 0xa6, BURST_TYPE},
	{0x97, 0xa9, BURST_TYPE},
	{0x98, 0xac, BURST_TYPE},
	{0x99, 0xaf, BURST_TYPE},
	{0x9a, 0xb3, BURST_TYPE},
	{0x9b, 0xb7, BURST_TYPE},
	{0x9c, 0xba, BURST_TYPE},
	{0x9d, 0xc1, BURST_TYPE},
	{0x9e, 0xc6, BURST_TYPE},
	{0x9f, 0xca, BURST_TYPE},
	{0xa0, 0xcf, BURST_TYPE},
	{0xa1, 0xd3, BURST_TYPE},
	{0xa2, 0xd7, BURST_TYPE},
	{0xa3, 0xdb, BURST_TYPE},
	{0xa4, 0xdf, BURST_TYPE},
	{0xa5, 0xe3, BURST_TYPE},
	{0xa6, 0xe5, BURST_TYPE},
	{0xa7, 0x14, BURST_TYPE},	//GMA02
	{0xa8, 0x21, BURST_TYPE},
	{0xa9, 0x31, BURST_TYPE},
	{0xaa, 0x3d, BURST_TYPE},
	{0xab, 0x49, BURST_TYPE},
	{0xac, 0x58, BURST_TYPE},
	{0xad, 0x64, BURST_TYPE},
	{0xae, 0x6f, BURST_TYPE},
	{0xaf, 0x79, BURST_TYPE},
	{0xb0, 0x82, BURST_TYPE},
	{0xb1, 0x8b, BURST_TYPE},
	{0xb2, 0x8f, BURST_TYPE},
	{0xb3, 0x94, BURST_TYPE},
	{0xb4, 0x99, BURST_TYPE},
	{0xb5, 0x9c, BURST_TYPE},
	{0xb6, 0x9f, BURST_TYPE},
	{0xb7, 0xa3, BURST_TYPE},
	{0xb8, 0xa6, BURST_TYPE},
	{0xb9, 0xa9, BURST_TYPE},
	{0xba, 0xac, BURST_TYPE},
	{0xbb, 0xaf, BURST_TYPE},
	{0xbc, 0xb3, BURST_TYPE},
	{0xbd, 0xb7, BURST_TYPE},
	{0xbe, 0xba, BURST_TYPE},
	{0xbf, 0xc1, BURST_TYPE},
	{0xc0, 0xc6, BURST_TYPE},
	{0xc1, 0xca, BURST_TYPE},
	{0xc2, 0xcf, BURST_TYPE},
	{0xc3, 0xd3, BURST_TYPE},
	{0xc4, 0xd7, BURST_TYPE},
	{0xc5, 0xdb, BURST_TYPE},
	{0xc6, 0xdf, BURST_TYPE},
	{0xc7, 0xe3, BURST_TYPE},
	{0xc8, 0xe5, BURST_TYPE},
	{0xc9, 0x00, BURST_TYPE},	//GMA03
	{0xca, 0x05, BURST_TYPE},
	{0xcb, 0x0a, BURST_TYPE},
	{0xcc, 0x12, BURST_TYPE},
	{0xcd, 0x1d, BURST_TYPE},
	{0xce, 0x2f, BURST_TYPE},
	{0xcf, 0x41, BURST_TYPE},
	{0xd0, 0x52, BURST_TYPE},
	{0xd1, 0x5c, BURST_TYPE},
	{0xd2, 0x66, BURST_TYPE},
	{0xd3, 0x6d, BURST_TYPE},
	{0xd4, 0x76, BURST_TYPE},
	{0xd5, 0x7d, BURST_TYPE},
	{0xd6, 0x84, BURST_TYPE},
	{0xd7, 0x89, BURST_TYPE},
	{0xd8, 0x8f, BURST_TYPE},
	{0xd9, 0x94, BURST_TYPE},
	{0xda, 0x98, BURST_TYPE},
	{0xdb, 0x9d, BURST_TYPE},
	{0xdc, 0xa3, BURST_TYPE},
	{0xdd, 0xa8, BURST_TYPE},
	{0xde, 0xb1, BURST_TYPE},
	{0xdf, 0xba, BURST_TYPE},
	{0xe0, 0xc2, BURST_TYPE},
	{0xe1, 0xd1, BURST_TYPE},
	{0xe2, 0xdd, BURST_TYPE},
	{0xe3, 0xe6, BURST_TYPE},
	{0xe4, 0xed, BURST_TYPE},
	{0xe5, 0xf3, BURST_TYPE},
	{0xe6, 0xf7, BURST_TYPE},
	{0xe7, 0xf9, BURST_TYPE},
	{0xe8, 0xfb, BURST_TYPE},
	{0xe9, 0xfd, BURST_TYPE},
	{0xea, 0xff, BURST_TYPE},
	{0xeb, 0x00, BURST_TYPE},	//GMA04
	{0xec, 0x05, BURST_TYPE},
	{0xed, 0x0a, BURST_TYPE},
	{0xee, 0x12, BURST_TYPE},
	{0xef, 0x1d, BURST_TYPE},
	{0xf0, 0x2f, BURST_TYPE},
	{0xf1, 0x41, BURST_TYPE},
	{0xf2, 0x52, BURST_TYPE},
	{0xf3, 0x5c, BURST_TYPE},
	{0xf4, 0x66, BURST_TYPE},
	{0xf5, 0x6d, BURST_TYPE},
	{0xf6, 0x76, BURST_TYPE},
	{0xf7, 0x7d, BURST_TYPE},
	{0xf8, 0x84, BURST_TYPE},
	{0xf9, 0x89, BURST_TYPE},
	{0xfa, 0x8f, BURST_TYPE},
	{0xfb, 0x94, BURST_TYPE},
	{0xfc, 0x98, BURST_TYPE},
	{0xfd, 0x9d, BURST_TYPE},	//- Burst Stop
	
	{0x03, 0xd0, BYTE_LEN},	//Page d0
	{0x10, 0xa3, BURST_TYPE},	//- Burst Start
	{0x11, 0xa8, BURST_TYPE},
	{0x12, 0xb1, BURST_TYPE},
	{0x13, 0xba, BURST_TYPE},
	{0x14, 0xc2, BURST_TYPE},
	{0x15, 0xd1, BURST_TYPE},
	{0x16, 0xdd, BURST_TYPE},
	{0x17, 0xe6, BURST_TYPE},
	{0x18, 0xed, BURST_TYPE},
	{0x19, 0xf3, BURST_TYPE},
	{0x1a, 0xf7, BURST_TYPE},
	{0x1b, 0xf9, BURST_TYPE},
	{0x1c, 0xfb, BURST_TYPE},
	{0x1d, 0xfd, BURST_TYPE},
	{0x1e, 0xff, BURST_TYPE},
	{0x1f, 0x00, BURST_TYPE},	//GMA05
	{0x20, 0x05, BURST_TYPE},
	{0x21, 0x0a, BURST_TYPE},
	{0x22, 0x12, BURST_TYPE},
	{0x23, 0x1d, BURST_TYPE},
	{0x24, 0x2f, BURST_TYPE},
	{0x25, 0x41, BURST_TYPE},
	{0x26, 0x52, BURST_TYPE},
	{0x27, 0x5c, BURST_TYPE},
	{0x28, 0x66, BURST_TYPE},
	{0x29, 0x6d, BURST_TYPE},
	{0x2a, 0x76, BURST_TYPE},
	{0x2b, 0x7d, BURST_TYPE},
	{0x2c, 0x84, BURST_TYPE},
	{0x2d, 0x89, BURST_TYPE},
	{0x2e, 0x8f, BURST_TYPE},
	{0x2f, 0x94, BURST_TYPE},
	{0x30, 0x98, BURST_TYPE},
	{0x31, 0x9d, BURST_TYPE},
	{0x32, 0xa3, BURST_TYPE},
	{0x33, 0xa8, BURST_TYPE},
	{0x34, 0xb1, BURST_TYPE},
	{0x35, 0xba, BURST_TYPE},
	{0x36, 0xc2, BURST_TYPE},
	{0x37, 0xd1, BURST_TYPE},
	{0x38, 0xdd, BURST_TYPE},
	{0x39, 0xe6, BURST_TYPE},
	{0x3a, 0xed, BURST_TYPE},
	{0x3b, 0xf3, BURST_TYPE},
	{0x3c, 0xf7, BURST_TYPE},
	{0x3d, 0xf9, BURST_TYPE},
	{0x3e, 0xfb, BURST_TYPE},
	{0x3f, 0xfd, BURST_TYPE},
	{0x40, 0xff, BURST_TYPE},
	{0x41, 0x00, BURST_TYPE},	//GMA06
	{0x42, 0x03, BURST_TYPE},
	{0x43, 0x08, BURST_TYPE},
	{0x44, 0x12, BURST_TYPE},
	{0x45, 0x1a, BURST_TYPE},
	{0x46, 0x26, BURST_TYPE},
	{0x47, 0x31, BURST_TYPE},
	{0x48, 0x3f, BURST_TYPE},
	{0x49, 0x49, BURST_TYPE},
	{0x4a, 0x55, BURST_TYPE},
	{0x4b, 0x61, BURST_TYPE},
	{0x4c, 0x6a, BURST_TYPE},
	{0x4d, 0x70, BURST_TYPE},
	{0x4e, 0x77, BURST_TYPE},
	{0x4f, 0x7f, BURST_TYPE},
	{0x50, 0x85, BURST_TYPE},
	{0x51, 0x8b, BURST_TYPE},
	{0x52, 0x91, BURST_TYPE},
	{0x53, 0x95, BURST_TYPE},
	{0x54, 0x9a, BURST_TYPE},
	{0x55, 0x9f, BURST_TYPE},
	{0x56, 0xa7, BURST_TYPE},
	{0x57, 0xaf, BURST_TYPE},
	{0x58, 0xb7, BURST_TYPE},
	{0x59, 0xc4, BURST_TYPE},
	{0x5a, 0xd0, BURST_TYPE},
	{0x5b, 0xd9, BURST_TYPE},
	{0x5c, 0xe0, BURST_TYPE},
	{0x5d, 0xe7, BURST_TYPE},
	{0x5e, 0xed, BURST_TYPE},
	{0x5f, 0xf2, BURST_TYPE},
	{0x60, 0xf6, BURST_TYPE},
	{0x61, 0xf9, BURST_TYPE},
	{0x62, 0xfa, BURST_TYPE},
	{0x63, 0x00, BURST_TYPE},	//GMA07
	{0x64, 0x03, BURST_TYPE},
	{0x65, 0x08, BURST_TYPE},
	{0x66, 0x12, BURST_TYPE},
	{0x67, 0x1a, BURST_TYPE},
	{0x68, 0x26, BURST_TYPE},
	{0x69, 0x31, BURST_TYPE},
	{0x6a, 0x3f, BURST_TYPE},
	{0x6b, 0x49, BURST_TYPE},
	{0x6c, 0x55, BURST_TYPE},
	{0x6d, 0x61, BURST_TYPE},
	{0x6e, 0x6a, BURST_TYPE},
	{0x6f, 0x70, BURST_TYPE},
	{0x70, 0x77, BURST_TYPE},
	{0x71, 0x7f, BURST_TYPE},
	{0x72, 0x85, BURST_TYPE},
	{0x73, 0x8b, BURST_TYPE},
	{0x74, 0x91, BURST_TYPE},
	{0x75, 0x95, BURST_TYPE},
	{0x76, 0x9a, BURST_TYPE},
	{0x77, 0x9f, BURST_TYPE},
	{0x78, 0xa7, BURST_TYPE},
	{0x79, 0xaf, BURST_TYPE},
	{0x7a, 0xb7, BURST_TYPE},
	{0x7b, 0xc4, BURST_TYPE},
	{0x7c, 0xd0, BURST_TYPE},
	{0x7d, 0xd9, BURST_TYPE},
	{0x7e, 0xe0, BURST_TYPE},
	{0x7f, 0xe7, BURST_TYPE},
	{0x80, 0xed, BURST_TYPE},
	{0x81, 0xf2, BURST_TYPE},
	{0x82, 0xf6, BURST_TYPE},
	{0x83, 0xf9, BURST_TYPE},
	{0x84, 0xfa, BURST_TYPE},
	{0x85, 0x00, BURST_TYPE},	//GMA08
	{0x86, 0x03, BURST_TYPE},
	{0x87, 0x08, BURST_TYPE},
	{0x88, 0x12, BURST_TYPE},
	{0x89, 0x1a, BURST_TYPE},
	{0x8a, 0x26, BURST_TYPE},
	{0x8b, 0x31, BURST_TYPE},
	{0x8c, 0x3f, BURST_TYPE},
	{0x8d, 0x49, BURST_TYPE},
	{0x8e, 0x55, BURST_TYPE},
	{0x8f, 0x61, BURST_TYPE},
	{0x90, 0x6a, BURST_TYPE},
	{0x91, 0x70, BURST_TYPE},
	{0x92, 0x77, BURST_TYPE},
	{0x93, 0x7f, BURST_TYPE},
	{0x94, 0x85, BURST_TYPE},
	{0x95, 0x8b, BURST_TYPE},
	{0x96, 0x91, BURST_TYPE},
	{0x97, 0x95, BURST_TYPE},
	{0x98, 0x9a, BURST_TYPE},
	{0x99, 0x9f, BURST_TYPE},
	{0x9a, 0xa7, BURST_TYPE},
	{0x9b, 0xaf, BURST_TYPE},
	{0x9c, 0xb7, BURST_TYPE},
	{0x9d, 0xc4, BURST_TYPE},
	{0x9e, 0xd0, BURST_TYPE},
	{0x9f, 0xd9, BURST_TYPE},
	{0xa0, 0xe0, BURST_TYPE},
	{0xa1, 0xe7, BURST_TYPE},
	{0xa2, 0xed, BURST_TYPE},
	{0xa3, 0xf2, BURST_TYPE},
	{0xa4, 0xf6, BURST_TYPE},
	{0xa5, 0xf9, BURST_TYPE},
	{0xa6, 0xfa, BURST_TYPE},
	{0xa7, 0x00, BURST_TYPE},	//GMA09
	{0xa8, 0x03, BURST_TYPE},
	{0xa9, 0x08, BURST_TYPE},
	{0xaa, 0x12, BURST_TYPE},
	{0xab, 0x1a, BURST_TYPE},
	{0xac, 0x26, BURST_TYPE},
	{0xad, 0x31, BURST_TYPE},
	{0xae, 0x3f, BURST_TYPE},
	{0xaf, 0x49, BURST_TYPE},
	{0xb0, 0x55, BURST_TYPE},
	{0xb1, 0x61, BURST_TYPE},
	{0xb2, 0x6a, BURST_TYPE},
	{0xb3, 0x70, BURST_TYPE},
	{0xb4, 0x77, BURST_TYPE},
	{0xb5, 0x7f, BURST_TYPE},
	{0xb6, 0x85, BURST_TYPE},
	{0xb7, 0x8b, BURST_TYPE},
	{0xb8, 0x91, BURST_TYPE},
	{0xb9, 0x95, BURST_TYPE},
	{0xba, 0x9a, BURST_TYPE},
	{0xbb, 0x9f, BURST_TYPE},
	{0xbc, 0xa7, BURST_TYPE},
	{0xbd, 0xaf, BURST_TYPE},
	{0xbe, 0xb7, BURST_TYPE},
	{0xbf, 0xc4, BURST_TYPE},
	{0xc0, 0xd0, BURST_TYPE},
	{0xc1, 0xd9, BURST_TYPE},
	{0xc2, 0xe0, BURST_TYPE},
	{0xc3, 0xe7, BURST_TYPE},
	{0xc4, 0xed, BURST_TYPE},
	{0xc5, 0xf2, BURST_TYPE},
	{0xc6, 0xf6, BURST_TYPE},
	{0xc7, 0xf9, BURST_TYPE},
	{0xc8, 0xfa, BURST_TYPE},
	{0xc9, 0x00, BURST_TYPE},	//GMA10
	{0xca, 0x03, BURST_TYPE},
	{0xcb, 0x08, BURST_TYPE},
	{0xcc, 0x12, BURST_TYPE},
	{0xcd, 0x1a, BURST_TYPE},
	{0xce, 0x26, BURST_TYPE},
	{0xcf, 0x31, BURST_TYPE},
	{0xd0, 0x3f, BURST_TYPE},
	{0xd1, 0x49, BURST_TYPE},
	{0xd2, 0x55, BURST_TYPE},
	{0xd3, 0x61, BURST_TYPE},
	{0xd4, 0x6a, BURST_TYPE},
	{0xd5, 0x70, BURST_TYPE},
	{0xd6, 0x77, BURST_TYPE},
	{0xd7, 0x7f, BURST_TYPE},
	{0xd8, 0x85, BURST_TYPE},
	{0xd9, 0x8b, BURST_TYPE},
	{0xda, 0x91, BURST_TYPE},
	{0xdb, 0x95, BURST_TYPE},
	{0xdc, 0x9a, BURST_TYPE},
	{0xdd, 0x9f, BURST_TYPE},
	{0xde, 0xa7, BURST_TYPE},
	{0xdf, 0xaf, BURST_TYPE},
	{0xe0, 0xb7, BURST_TYPE},
	{0xe1, 0xc4, BURST_TYPE},
	{0xe2, 0xd0, BURST_TYPE},
	{0xe3, 0xd9, BURST_TYPE},
	{0xe4, 0xe0, BURST_TYPE},
	{0xe5, 0xe7, BURST_TYPE},
	{0xe6, 0xed, BURST_TYPE},
	{0xe7, 0xf2, BURST_TYPE},
	{0xe8, 0xf6, BURST_TYPE},
	{0xe9, 0xf9, BURST_TYPE},
	{0xea, 0xfa, BURST_TYPE},
	{0xeb, 0x00, BURST_TYPE},	//GMA11
	{0xec, 0x03, BURST_TYPE},
	{0xed, 0x08, BURST_TYPE},
	{0xee, 0x12, BURST_TYPE},
	{0xef, 0x1a, BURST_TYPE},
	{0xf0, 0x26, BURST_TYPE},
	{0xf1, 0x31, BURST_TYPE},
	{0xf2, 0x3f, BURST_TYPE},
	{0xf3, 0x49, BURST_TYPE},
	{0xf4, 0x55, BURST_TYPE},
	{0xf5, 0x61, BURST_TYPE},
	{0xf6, 0x6a, BURST_TYPE},
	{0xf7, 0x70, BURST_TYPE},
	{0xf8, 0x77, BURST_TYPE},
	{0xf9, 0x7f, BURST_TYPE},
	{0xfa, 0x85, BURST_TYPE},
	{0xfb, 0x8b, BURST_TYPE},
	{0xfc, 0x91, BURST_TYPE},
	{0xfd, 0x95, BURST_TYPE},	//- Burst Stop

	{0x03, 0xd1, BYTE_LEN},	//Page d1
	{0x10, 0x9a, BURST_TYPE},	//- Burst Start
	{0x11, 0x9f, BURST_TYPE},
	{0x12, 0xa7, BURST_TYPE},
	{0x13, 0xaf, BURST_TYPE},
	{0x14, 0xb7, BURST_TYPE},
	{0x15, 0xc4, BURST_TYPE},
	{0x16, 0xd0, BURST_TYPE},
	{0x17, 0xd9, BURST_TYPE},
	{0x18, 0xe0, BURST_TYPE},
	{0x19, 0xe7, BURST_TYPE},
	{0x1a, 0xed, BURST_TYPE},
	{0x1b, 0xf2, BURST_TYPE},
	{0x1c, 0xf6, BURST_TYPE},
	{0x1d, 0xf9, BURST_TYPE},
	{0x1e, 0xfa, BURST_TYPE},
	...
	{0xff, 0x52, BURST_TYPE},	//- Burst Stop
	
	{0x03, 0xd2, BYTE_LEN},	//Page d2
	{0x10, 0x86, BURST_TYPE},//3_HUE   	//- Burst Start
	...
	{0xff, 0x76, BURST_TYPE},	//- Burst Stop

	{0x03, 0xd3, BYTE_LEN},	//Page d3
	{0x10, 0x0c, BURST_TYPE},	//4_HUE		//- Burst Start
	...
	{0x1b, 0x20, BURST_TYPE},//LSC 00 Gain GB
	{0x1c, 0x20, BURST_TYPE},//LSC 00 Gain B 
	{0x1d, 0x20, BURST_TYPE}, //LSC 00 Gain R
	{0x1e, 0x20, BURST_TYPE},//LSC 00 Gain GR
	...
	{0x23, 0x20, BURST_TYPE},//LSC 01 Gain GB
	{0x24, 0x20, BURST_TYPE},//LSC 01 Gain B 
	{0x25, 0x20, BURST_TYPE}, //LSC 01 Gain R 
	{0x26, 0x20, BURST_TYPE},//LSC 01 Gain GR
	...
	{0x2b, 0x20, BURST_TYPE},//LSC 02 Gain GB
	{0x2c, 0x20, BURST_TYPE},//LSC 02 Gain B 
	{0x2d, 0x20, BURST_TYPE}, //LSC 02 Gain R 
	{0x2e, 0x20, BURST_TYPE},//LSC 02 Gain GR
	...
	{0x91, 0x80, BURST_TYPE}, //DNP CR	//- Burst Stop
	...
	{0x03, 0xd9, BYTE_LEN},
	{0x10, 0x03, BURST_TYPE},	//- Burst Start
	...
	{0xbf, 0x40, BURST_TYPE},	//- Burst Stop
	///////////////////////////////////
	...
	{0x20, 0x32, BURST_TYPE},
	{0x21, 0x70, BURST_TYPE},
	{0x22, 0x33, BURST_TYPE},
	{0x23, 0x4a, BURST_TYPE},
	{0x24, 0x34, BURST_TYPE},
	{0x25, 0x2a, BURST_TYPE},
	{0x26, 0x35, BURST_TYPE},
	{0x27, 0x2b, BURST_TYPE},
	          
	{0x28, 0x36, BURST_TYPE},
	{0x29, 0x16, BURST_TYPE},
	{0x2a, 0x37, BURST_TYPE},
	{0x2b, 0x1b, BURST_TYPE},
	{0x2c, 0x38, BURST_TYPE},
	{0x2d, 0x14, BURST_TYPE},
	...
	{0xff, 0x0a, BURST_TYPE},	//- Burst Stop

	// Page 0xdb          
	{0x03, 0xdb, BYTE_LEN},
	{0x10, 0x45, BURST_TYPE},	//- Burst Start
	...
	{0xff, 0x20, BURST_TYPE},	//- Burst Stop

	{0x03, 0xdc, BYTE_LEN},
	{0x10, 0x3c, BURST_TYPE},	//- Burst Start
	...
	{0x69, 0x30, BURST_TYPE}, //outdoor again max 	//- Burst Stop
	//////////////////
	// dd Page (DMA Indoor)
	//////////////////
	{0x03, 0xdd, BYTE_LEN},
	{0x10, 0x03, BURST_TYPE},	//Indoor Page11		//- Burst Start
	...
	{0xfd, 0x02, BURST_TYPE},	//- Burst Stop

	{0x03, 0xde, BYTE_LEN},
	{0x10, 0x45, BURST_TYPE}, //Indoor 0x1245	//- Burst Start
	{0x11, 0x0a, BURST_TYPE},
	...
	{0xfd, 0x30, BURST_TYPE},	//- Burst Stop
              
	{0x03, 0xdf, BYTE_LEN},
	{0x10, 0x3c, BURST_TYPE},	//Indoor 0x143c	//- Burst Start
	...
	{0x68, 0x51, BURST_TYPE},
	{0x69, 0xC0, BURST_TYPE},	//- Burst Stop
	...
	{0x03, 0xe1, BYTE_LEN},
	{0x10, 0x45, BURST_TYPE}, //Dark1 0x1245	//- Burst Start
	{0x11, 0x0a, BURST_TYPE},
	...
	{0xfd, 0x20, BURST_TYPE},	//- Burst Stop

	{0x03, 0xe2, BYTE_LEN},
	{0x10, 0x3c, BURST_TYPE}, //Dark1 0x143c	//- Burst Start
	...
	{0x68, 0x51, BURST_TYPE}, //
	{0x69, 0xc0, BURST_TYPE}, // a0 -> c0	//- Burst Stop
	...
	{0x03, 0xe3, BYTE_LEN},
	{0x10, 0x03, BURST_TYPE},	//Dark2 Page11	//- Burst Start
	{0x11, 0x11, BURST_TYPE},
	...
	{0x1f, 0x20, BURST_TYPE},
	{0x20, 0x32, BURST_TYPE},	//Dark2 0x1132
	{0x21, 0x82, BURST_TYPE},//82
	{0x22, 0x33, BURST_TYPE},	//Dark2 0x1133
	{0x23, 0x5d, BURST_TYPE},//5d
	{0x24, 0x34, BURST_TYPE},	//Dark2 0x1134
	{0x25, 0x37, BURST_TYPE},//37
	{0x26, 0x35, BURST_TYPE},	//Dark2 0x1135
	{0x27, 0x30, BURST_TYPE},//30
	{0x28, 0x36, BURST_TYPE},	//Dark2 0x1136
	{0x29, 0x18, BURST_TYPE},//18
	{0x2a, 0x37, BURST_TYPE},	//Dark2 0x1137
	{0x2b, 0x24, BURST_TYPE},//24
	...
	{0xf1, 0x29, BURST_TYPE},
	{0xf2, 0x08, BURST_TYPE}, //Dark2 0x1212
	{0xf3, 0x30, BURST_TYPE},
	...
	{0x03, 0xe4, BYTE_LEN},
	{0x10, 0x45, BURST_TYPE}, //Dark2 0x1245	//- Burst Start
	{0x11, 0x0a, BURST_TYPE},
	...
	{0x03, 0xe5, BYTE_LEN},
	{0x10, 0x3c, BURST_TYPE}, //Dark2 0x143c	//- Burst Start
	{0x11, 0x18, BURST_TYPE},
	...
	{0x67, 0x20, BURST_TYPE}, //
	{0x68, 0x51, BURST_TYPE}, //
	{0x69, 0xc0, BURST_TYPE}, // a0 -> c0 register / value	//- Burst Stop
	...
	// DMA END
        ...
        {0x03, 0xc0, BYTE_LEN},
        {0x33, 0x00, BYTE_LEN},	// Hand shake & Request on
        {0x32, 0x01, BYTE_LEN},	// 
        {0x03, 0x30, BYTE_LEN},
        {0x11, 0x84, BYTE_LEN}, //Bit[0]: MCU hold off
	...
	{0x14, 0x10, BYTE_LEN}, 
	{0x15, 0x00, BYTE_LEN}, 
	{0x21, 0x14, BYTE_LEN}, //ssd_x_start_pos
	{0x22, 0x8C, BYTE_LEN}, //ssd_y_start_pos
	...
	{0x03, 0x30, BYTE_LEN},
	{0x11, 0x84, BYTE_LEN},	// m2i hold off

	{0x03, 0xc0, BYTE_LEN},
	{0xe1, 0x00, BYTE_LEN}, //PCON MODE OFF

	{0x03, 0x30, BYTE_LEN},
	{0x25, 0x0e, BYTE_LEN},	// pcon wake up
	{0x25, 0x1e, BYTE_LEN},	// normal

	{0x03, 0xc4, BYTE_LEN}, //AE Static en
	{0x10, 0xE7, BYTE_LEN},

	{0x03, 0xc3, BYTE_LEN}, //AE en
	{0x10, 0x84, BYTE_LEN},
	...
	{0x10, 0xaf, BYTE_LEN}, //Yoffset, Contrast Off
	...
	{0x20, 0x02, BURST_TYPE},	//ZOOM_DST_WIDTH_H    	//- Burst Start
	{0x21, 0x80, BURST_TYPE},	//ZOOM_DST_WIDTH_L    
	{0x22, 0x01, BURST_TYPE},	//ZOOM_DST_HEIGHT_H   
	{0x23, 0xe0, BURST_TYPE},	//ZOOM_DST_HEIGHT_L   
	{0x24, 0x00, BURST_TYPE},	//ZOOM_WIN_STX_H      
	{0x25, 0x03, BURST_TYPE},	//ZOOM_WIN_STX_L      
	{0x26, 0x00, BURST_TYPE},	//ZOOM_WIN_STY_H      
	{0x27, 0x01, BURST_TYPE},	//ZOOM_WIN_STY_L      
	{0x28, 0x02, BURST_TYPE},	//ZOOM_WIN_ENX_H      
	{0x29, 0x83, BURST_TYPE},	//ZOOM_WIN_ENX_L      
	{0x2a, 0x01, BURST_TYPE},	//ZOOM_WIN_ENY_H      
	{0x2b, 0xe1, BURST_TYPE},	//ZOOM_WIN_ENY_L      
	{0x2c, 0x0c, BURST_TYPE},	//ZOOM_VER_STEP_H     
	{0x2d, 0xcc, BURST_TYPE},	//ZOOM_VER_STEP_L     
	{0x2e, 0x0c, BURST_TYPE},	//ZOOM_HOR_STEP_H     
	{0x2f, 0xcc, BURST_TYPE},	//ZOOM_HOR_STEP_L     
	{0x30, 0x42, BURST_TYPE},	//ZOOM_FIFO_DELAY     	//- Burst Stop

	{0x03, 0x1F, BYTE_LEN},
	{0x23, 0xa0, BYTE_LEN}, //SSD Block Height
	...
	{0x11, 0x00, BYTE_LEN}, //Normal Mode(non-continous): 00 continuous : 10
...
struct hi351_i2c_reg_conf hi351_prev_settings[] = {
	...
	{0x03, 0x30, BYTE_LEN},
	{0x36, 0xa3, BYTE_LEN}, //adaptive,dma off
...
//////////////////////////////////////////////
	...
	{0x10, 0xb1, BYTE_LEN},
	{0x03, 0x30, BYTE_LEN},
	{0x36, 0xa2, BYTE_LEN}, //adaptive,dma on
...
//	{0x01, 0xf1},
	...
	//ISO Auto
	{0x51, 0xA0, BYTE_LEN}, //Max Gain
	{0x52, 0x28, BYTE_LEN}, //Min Gain
	
	{0x03, 0xc4, BYTE_LEN},
	{0x19, 0x40, BYTE_LEN}, //Bnd0 Gain
	{0x1a, 0x44, BYTE_LEN}, //Bnd1 Gain
	...
	{0x10, 0x30, BYTE_LEN}, //adaptive on
	...
	{0x2e, 0x9a, BYTE_LEN},	//SATB_03"
	{0x2f, 0x94, BYTE_LEN},	//SATB_04"
	{0x30, 0x94, BYTE_LEN},	//SATB_05"
	{0x31, 0x98, BYTE_LEN},	//SATB_06"
	{0x32, 0x98, BYTE_LEN},	//SATB_07"
	{0x33, 0x98, BYTE_LEN},	//SATB_08"
	{0x34, 0x98, BYTE_LEN},	//SATB_09"
	{0x35, 0x98, BYTE_LEN},	//SATB_10"
	{0x36, 0x98, BYTE_LEN},	//SATB_11"
	
	//SATR 
	{0x37, 0x70, BYTE_LEN},	//SATR_00"
	{0x38, 0x70, BYTE_LEN},	//SATR_01"
	{0x39, 0x70, BYTE_LEN},	//SATR_02"
	{0x3a, 0x8a, BYTE_LEN},	//SATR_03"
	{0x3b, 0x88, BYTE_LEN},	//SATR_04"
	{0x3c, 0x88, BYTE_LEN},	//SATR_05"
	{0x3d, 0x8c, BYTE_LEN},	//SATR_06"
	{0x3e, 0x8c, BYTE_LEN},	//SATR_07"
	{0x3f, 0x8c, BYTE_LEN},	//SATR_08"
	{0x40, 0x8c, BYTE_LEN},	//SATR_09"
	{0x41, 0x8c, BYTE_LEN},	//SATR_10"
	{0x42, 0x8c, BYTE_LEN},	//SATR_11"
...
//	{0x01, 0xf1},
	...
	{0x03, 0xe0, BYTE_LEN},
	{0x1d, 0x28, BYTE_LEN},//dark1
	{0x03, 0xe3, BYTE_LEN},
	{0x1d, 0x28, BYTE_LEN},//dark2
...
struct hi351_i2c_reg_conf hi351_scene_night_settings[] = {
	...
	{0x26, 0x55, BYTE_LEN}, 
	{0x27, 0x10, BYTE_LEN}, 
	{0x03, 0xc4, BYTE_LEN}, //AE On
	{0x10, 0xe1, BYTE_LEN},
	{0x03, 0xcf, BYTE_LEN}, //page cf
	{0x11, 0xbd, BYTE_LEN}, //00//Y_LUM max //5fps, AG,DG MAX
	{0x12, 0x5c, BYTE_LEN},
	{0x13, 0xbd, BYTE_LEN},
	{0x14, 0x5c, BYTE_LEN},
...
struct hi351_i2c_reg_conf hi351_auto_framerate_settings[] = {
		...
		//{0x01, 0xf0, BYTE_LEN},
		{0x03, 0x30, BYTE_LEN},
		{0x36, 0xa2, BYTE_LEN}, //dma & adaptive on  
...
struct hi351_i2c_reg_conf hi351_fixed_framerate_settings[] = {
	...
	{0x22, 0x74, BYTE_LEN}, 
	{0x23, 0x70, BYTE_LEN}, 
	{0x24, 0x00, BYTE_LEN}, //EXP Max 20.00 fps 
	{0x25, 0x1b, BYTE_LEN}, 
	{0x26, 0x74, BYTE_LEN}, 
	{0x27, 0x70, BYTE_LEN}, 
	{0x28, 0x00, BYTE_LEN}, //EXPMin 25210.08 fps
...
struct hi351_i2c_reg_conf hi351_attached_framerate_settings[] = {
	...
	{0x03, 0xc5, BYTE_LEN}, //AWB off
	{0x03, 0x20, BYTE_LEN}, //Page 20
	{0x20, 0x00, BYTE_LEN}, //EXP Normal 15.00 fps 
	{0x21, 0x24, BYTE_LEN}, 
	{0x22, 0x9b, BYTE_LEN}, 
	{0x23, 0x40, BYTE_LEN}, 
	{0x24, 0x00, BYTE_LEN}, //EXP Max 30.00 fps 
	...
	{0x03, 0x00, BYTE_LEN}, //PAGE 0
	{0x90, 0x03, BYTE_LEN}, //BLC_TIME_TH_ON
	{0x91, 0x03, BYTE_LEN}, //BLC_TIME_TH_OFF 
	{0x92, 0x98, BYTE_LEN}, //BLC_AG_TH_ON
	{0x93, 0x90, BYTE_LEN}, //BLC_AG_TH_OFF
	{0x03, 0xc4, BYTE_LEN},
	{0x10, 0xe1, BYTE_LEN},
...
struct hi351_i2c_reg_conf hi351_wb_incandescent_settings[] = {
	...
	{0x18, 0x40, BYTE_LEN}, //bInRgainMin_a00_n00 
	{0x19, 0x58, BYTE_LEN}, //bInRgainMax_a00_n00 

	{0x1a, 0x84, BYTE_LEN}, //bInBgainMin_a00_n00 
	{0x1b, 0x9c, BYTE_LEN}, //bInBgainMax_a00_n00 
	
	{0xb9, 0x40, BYTE_LEN}, //bOutRgainMin_a00_n00  
	{0xba, 0x58, BYTE_LEN}, //bOutRgainMax_a00_n00  
            
	{0xbb, 0x84, BYTE_LEN}, //bOutBgainMin_a00_n00  
	{0xbc, 0x9c, BYTE_LEN}, //bOutBgainMax_a00_n00  
...
//	DISP_NAME = " Florecent(tl84)"
	...
	{0x18, 0x45, BYTE_LEN}, //bInRgainMin_a00_n00 
	{0x19, 0x5d, BYTE_LEN}, //bInRgainMax_a00_n00 

	{0x1a, 0x6a, BYTE_LEN}, //bInBgainMin_a00_n00 
	{0x1b, 0x82, BYTE_LEN}, //bInBgainMax_a00_n00 
	
	{0xb9, 0x45, BYTE_LEN}, //bOutRgainMin_a00_n00  
	{0xba, 0x5d, BYTE_LEN}, //bOutRgainMax_a00_n00  
            
	{0xbb, 0x6a, BYTE_LEN}, //bOutBgainMin_a00_n00  
	{0xbc, 0x82, BYTE_LEN}, //bOutBgainMax_a00_n00  
...
struct hi351_i2c_reg_conf hi351_wb_daylight_settings[] = {
	...
	{0x18, 0x67, BYTE_LEN}, //bInRgainMin_a00_n00 
	{0x19, 0x7f, BYTE_LEN}, //bInRgainMax_a00_n00 

	{0x1a, 0x48, BYTE_LEN}, //bInBgainMin_a00_n00 
	{0x1b, 0x60, BYTE_LEN}, //bInBgainMax_a00_n00 
	
	{0xb9, 0x67, BYTE_LEN}, //bOutRgainMin_a00_n00  
	{0xba, 0x7f, BYTE_LEN}, //bOutRgainMax_a00_n00  
            
	{0xbb, 0x48, BYTE_LEN}, //bOutBgainMin_a00_n00  
...
struct hi351_i2c_reg_conf hi351_iso_auto_settings[] = {
	...
	{0x03, 0xD5, BYTE_LEN},				  
	{0x10, 0x01, BYTE_LEN}, // ISO AUTO control 
	//{0x10, 0x11, BYTE_LEN}, // ISO 1 control 
	//{0x10, 0x21, BYTE_LEN}, // ISO 2 control 
	//{0x10, 0x31, BYTE_LEN}, // ISO 3 control 
	//{0x10, 0x41, BYTE_LEN}, // ISO 4 control 
	//{0x10, 0x51, BYTE_LEN}, // ISO 5 control 
	//{0x10, 0x61, BYTE_LEN}, // ISO 6 control 
	{0x21, 0x09, BYTE_LEN}, //Capture line 				
	{0x22, 0xc4, BYTE_LEN}, //Capture line 				
	{0x2e, 0x10, BYTE_LEN}, //De-shutter target AG min
	{0x2f, 0xa0, BYTE_LEN}, //De-shutter target AG max(only deshutter Y correction option enable) (80 -> a0)
	
	{0x2a, 0x38, BYTE_LEN}, //Shutter_AG th *if(AG < this reg)current scene = shutter up mode!
	{0x2b, 0x10, BYTE_LEN}, //insert the value of decrresing exposure time(%)
	
	{0x86, 0x01, BYTE_LEN}, // preview mode pll2 main divider cal value 
	{0x1e, 0x01, BYTE_LEN}, // capture mode opclk divider value
