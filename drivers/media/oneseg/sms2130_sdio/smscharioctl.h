...
//jason110208
#define SMSCHAR_SET_POWER_UP   _IOW('K', 10, int)
#define SMSCHAR_SET_POWER_DOWN _IOW('K', 11, int)
#define SMSCHAR_RESET_DEVICE_MODE _IOW('K', 12, int)

#define SMSCHAR_PROBE_STATUS_CHECK _IOR('K', 13, int)

#define SMSCHAR_START_DEVICE_MODE _IOW('K', 14, int)
